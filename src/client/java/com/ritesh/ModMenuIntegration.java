...
public class ModMenuIntegration implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            aim.addEntry(eb.startIntSlider(Component.translatable("text.autoconfig.bettermaceswap.option.aimIntensity"), config.aimIntensity, 20, 100).setDefaultValue(25).setTooltip(Component.translatable("text.autoconfig.bettermaceswap.option.aimIntensity.@Tooltip")).setSaveConsumer(v -> config.aimIntensity = v).build());
