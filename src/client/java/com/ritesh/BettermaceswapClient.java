    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (!breachPressed && wasBreachSwapPressed) {
                ...
                ModConfig.save();
                client.gui.setOverlayMessage(Component.literal("Attribute Swap: ").append(
            ...
            if (!stunPressed && wasStunSlamPressed) {
                ...
                ModConfig.save();
                client.gui.setOverlayMessage(Component.literal("Stun Slam: ").append(
            ...
            if (!cyclePressed && wasMaceCyclePressed) {
                ...
                client.gui.setOverlayMessage(Component.literal("Mace Mode: ").append(
            ...
            if (!pearlPressed && wasPearlCatchPressed) {
                ...
                ModConfig.save();
                client.gui.setOverlayMessage(Component.literal("Pearl Catch: ").append(
            ...
            if (!assistPressed && wasAimAssistPressed) {
                ...
                ModConfig.save();
                client.gui.setOverlayMessage(Component.literal("Aim Assist: ").append(
            ...
            if (!triggerPressed && wasTriggerBotPressed) {
                ...
                ModConfig.save();
                client.gui.setOverlayMessage(Component.literal("Trigger Bot: ").append(
            ...
            if (!aimModePressed && wasAimModePressed) {
                ...
                ModConfig.save();
                client.gui.setOverlayMessage(Component.literal("Aim Mode: ").append(
